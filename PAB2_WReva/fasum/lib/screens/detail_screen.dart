...
class _DetailScreenState extends State<DetailScreen> {
  Uint8List? _decodeImageBytes() {
    if (widget.imageBase64.isEmpty) return null;
    try {
      return base64Decode(widget.imageBase64);
    } catch (_) {
      return null;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final imageBytes = _decodeImageBytes();
