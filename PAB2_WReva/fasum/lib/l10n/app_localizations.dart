...
abstract class AppLocalizations {
  ...
  ///
  /// In id, this message translates to:
  /// **'Akun dengan email tersebut sudah digunakan.'**
  ...
  ///
  /// In id, this message translates to:
  /// **'Gagal mengunggah postingan: {error}'**
  ...
  ///
  /// In id, this message translates to:
  /// **'❌ Gagal mengirim notifikasi: {error}'**
  ...
  /// No description provided for @unableToDisplayReport.
  ///
  /// In id, this message translates to:
  /// **'Tidak bisa menampilkan laporan ini'**
  String get unableToDisplayReport;
  ...
  /// No description provided for @newReportNotificationTitle.
  ///
  /// In id, this message translates to:
  /// **'⚠️ Laporan Baru'**
  String get newReportNotificationTitle;
}
